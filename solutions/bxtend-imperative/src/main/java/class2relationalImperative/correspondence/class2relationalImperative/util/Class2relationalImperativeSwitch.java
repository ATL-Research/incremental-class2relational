/**
 */
package class2relationalImperative.correspondence.class2relationalImperative.util;
...
public class Class2relationalImperativeSwitch <T> extends Switch <T> {
	 ...
	 * @generated
	 */
	protected static Class2relationalImperativePackage modelPackage;
	 ...
	 * @generated
	 */
	public Class2relationalImperativeSwitch() {
		if (modelPackage == null) {
			modelPackage = Class2relationalImperativePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Class2relationalImperativePackage.TRANSFORMATION: {
				Transformation transformation = (Transformation)theEObject;
				T result = caseTransformation(transformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Class2relationalImperativePackage.CORR: {
				Corr corr = (Corr)theEObject;
				T result = caseCorr(corr);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Class2relationalImperativePackage.BASIC_ELEM: {
...
} //Class2relationalImperativeSwitch
