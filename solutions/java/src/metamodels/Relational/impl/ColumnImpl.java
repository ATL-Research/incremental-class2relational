 ...
 * </p>
 * <ul>
 *   <li>{@link metamodels.Relational.impl.ColumnImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link metamodels.Relational.impl.ColumnImpl#getKeyOf <em>Key Of</em>}</li>
 *   <li>{@link metamodels.Relational.impl.ColumnImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnImpl extends NamedImpl implements Column {
	...
	public void setOwner(Table newOwner) {
		if (newOwner != eInternalContainer() || (eContainerFeatureID() != RelationalPackage.COLUMN__OWNER && newOwner != null)) {
			...
			if (newOwner != null)
				msgs = ((InternalEObject)newOwner).eInverseAdd(this, RelationalPackage.TABLE__COL, Table.class, msgs);
		...
		if (keyOf != null && keyOf.eIsProxy()) {
			...
			if (keyOf != oldKeyOf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RelationalPackage.COLUMN__KEY_OF, oldKeyOf, keyOf));
			}
		}
		return keyOf;
	}
	...
	public NotificationChain basicSetKeyOf(Table newKeyOf, NotificationChain msgs) {
		...
		keyOf = newKeyOf;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RelationalPackage.COLUMN__KEY_OF, oldKeyOf, newKeyOf);
	...
	public void setKeyOf(Table newKeyOf) {
		if (newKeyOf != keyOf) {
			NotificationChain msgs = null;
			if (keyOf != null)
				msgs = ((InternalEObject)keyOf).eInverseRemove(this, RelationalPackage.TABLE__KEY, Table.class, msgs);
			if (newKeyOf != null)
				msgs = ((InternalEObject)newKeyOf).eInverseAdd(this, RelationalPackage.TABLE__KEY, Table.class, msgs);
			msgs = basicSetKeyOf(newKeyOf, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.COLUMN__KEY_OF, newKeyOf, newKeyOf));
	}
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.COLUMN__TYPE, oldType, type));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RelationalPackage.COLUMN__KEY_OF:
				if (keyOf != null)
					msgs = ((InternalEObject)keyOf).eInverseRemove(this, RelationalPackage.TABLE__KEY, Table.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case RelationalPackage.COLUMN__OWNER:
				return eInternalContainer().eInverseRemove(this, RelationalPackage.TABLE__COL, Table.class, msgs);
		}
