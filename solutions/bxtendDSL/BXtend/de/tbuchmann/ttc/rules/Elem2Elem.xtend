...
abstract class Elem2Elem {
	...
	val protected Class2Relational trafo
	...
	val static sourceFactory = atl.research.class_.Class_Factory::eINSTANCE
	...
	public static def getCorrMap() {
		return elementsToCorr
	} 
}
