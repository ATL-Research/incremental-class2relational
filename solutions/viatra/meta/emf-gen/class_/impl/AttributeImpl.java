...
public class AttributeImpl extends NamedEltImpl implements Attribute {
	 ...
	 * @generated
	 */
	public class_.Class getOwner() {
		if (eContainerFeatureID() != Class_Package.ATTRIBUTE__OWNER) return null;
		return (class_.Class)eInternalContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOwner(class_.Class newOwner, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setOwner(class_.Class newOwner) {
		if (newOwner != eInternalContainer() || (eContainerFeatureID() != Class_Package.ATTRIBUTE__OWNER && newOwner != null)) {
			...
			if (newOwner != null)
				msgs = ((InternalEObject)newOwner).eInverseAdd(this, Class_Package.CLASS__ATTR, class_.Class.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Class_Package.ATTRIBUTE__OWNER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetOwner((class_.Class)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case Class_Package.ATTRIBUTE__OWNER:
				return eInternalContainer().eInverseRemove(this, Class_Package.CLASS__ATTR, class_.Class.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Class_Package.ATTRIBUTE__TYPE:
				...
				return;
			case Class_Package.ATTRIBUTE__OWNER:
				setOwner((class_.Class)newValue);
				return;
		}
