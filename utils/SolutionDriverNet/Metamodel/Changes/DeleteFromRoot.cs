...
namespace HSRM.TTC2023.ClassToRelational.Changes
{
    ...
    /// <summary>
    /// The default implementation of the DeleteFromRoot class
    /// </summary>
    ...
    public partial class DeleteFromRoot : NMF.Models.Changes.ElementaryChange, IDeleteFromRoot, NMF.Models.IModelElement
    {
        ...
        public NMF.Models.IModelElement DeletedElement
        {
            ...
            set
            {
                if ((this._deletedElement != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.Deleted -= this.OnResetDeletedElement;
                    }
                    if ((value != null))
                    {
                        value.Deleted += this.OnResetDeletedElement;
                    }
        ...
        public override IEnumerableExpression<NMF.Models.IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new DeleteFromRootReferencedElementsCollection(this));
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://nmf.codeplex.com/changes#//DeleteFromRoot")));
                }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((NMF.Models.ModelElement)(HSRM.TTC2023.ClassToRelational.Changes.DeleteFromRoot.ClassInstance)).Resolve("deletedElement")));
        }
        ...
        public class DeleteFromRootReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            /// </summary>
            public DeleteFromRootReferencedElementsCollection(DeleteFromRoot parent)
            {
                this._parent = parent;
            }
