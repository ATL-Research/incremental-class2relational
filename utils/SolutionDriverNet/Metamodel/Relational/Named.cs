    ...
    public abstract partial class Named : ModelElement, INamed, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("https://github.com/ATL-Research/incremental-class2relational/Relational.nmeta#//N" +
                            "amed")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(HSRM.TTC2023.ClassToRelational.Relational_.Named.ClassInstance)).Resolve("name")));
        }
