...
public class Relational_PackageImpl extends EPackageImpl implements Relational_Package {
	...
	public void initializePackageContents() {
		...
		initEReference(getColumn_Owner(), this.getTable(), this.getTable_Col(), "owner", null, 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
